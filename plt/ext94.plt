...
LIN0 =`wc -l '../dat/expl_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/expl_ext94/%s.dat)", i, f, pl)
...
LIN0 =`wc -l '../dat/simp_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/simp_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
...
LIN0 =`wc -l '../dat/stor_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/stor_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
...
LIN0 =`wc -l '../dat/llib_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/llib_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
...
LIN0 =`wc -l '../dat/rk-4_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/rk-4_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
...
LIN0 =`wc -l '../dat/rkn4_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/rkn4_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
...
LIN0 =`wc -l '../dat/rkg4_ext94/err.dat' | cut -d' ' -f1`
LIN1 = LIN0 - 1
arxiu(i, f, pl) = sprintf("<(sed -n '%d,%dp' ../dat/rkg4_ext94/%s.dat)", i, f, pl)
splot arxiu(1, LIN0, "sol")    u 2:3:4 w l ls 1, \
      arxiu(1, LIN0, "jup")    u 2:3:4 w l ls 2, \
      arxiu(1, LIN0, "sat")    u 2:3:4 w l ls 3, \
      arxiu(1, LIN0, "ura")    u 2:3:4 w l ls 4, \
